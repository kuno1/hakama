<div class="site-header-brand">
	<a href="<?php echo home_url() ?>" rel="home" class="site-header-brand-link" title="<?php bloginfo( 'name' ) ?>">
		<img class="site-header-logo-symbol"
			 src="<?php echo get_template_directory_uri() ?>/src/img/kunoichi-logo.svg?ver=2"
			 alt="<?php bloginfo( 'name' ); ?>" width="50" height="50" />
		<img class="site-header-logo-type"
			 src="<?php echo get_template_directory_uri() ?>/src/img/kunoichi-type.svg?ver=2"
			 alt="<?php bloginfo( 'description' ); ?>" width="180" height="50" />
	</a>
</div>
